...
public class HollowHeapLargeRandomTest {
    public static void testAddAndExtract100000() {
        HollowHeap<Integer> fibHeap = new HollowHeap<>();
        ...
        System.out.println(HollowHeapLargeRandomTest.class.getName() + "/testAddAndExtract100000: Passed");
    }
    ...
    public static void peekMinWithoutExtracting() {
        ...
        System.out.println(HollowHeapLargeRandomTest.class.getName() + "/peekMinWithoutExtracting: Passed");
    }
    ...
    public static void testDecreaseKey() {
        ...
        System.out.println(HollowHeapLargeRandomTest.class.getName() + "/testDecreaseKey: Passed");
    }
    ...
    public static void merge() {
        ...
        System.out.println(HollowHeapLargeRandomTest.class.getName() + "/merge: Passed");
    }
}
